...
dictL10NSTR = {
    'en-US': {
        ...
        'pluginAPI_0016': 'OlivOS plugin shallow [{0}] priority order applied: {1}',
        ...
        'milkyAutoServerAPI_0001': 'OlivOS milky auto server [{0}] websocket link start',
        'milkyAutoServerAPI_0002': 'OlivOS milky auto server [{0}] websocket link close',
        'milkyAutoServerAPI_0003': 'OlivOS milky auto server [{0}] websocket link lost',
        'milkyAutoServerAPI_0004': 'OlivOS milky auto server [{0}] websocket link will retry in {1}s',
        'milkyAutoServerAPI_0005': 'OlivOS milky auto server [{0}] websocket link error: \n{1}',
        ...
        'qqGuildv2WebhookServerAPI_0001': 'OlivOS qqGuildv2 webhook server [{0}] is running on [{1}]',
        'qqGuildv2WebhookServerAPI_0002': 'OlivOS qqGuildv2 webhook server [{0}] auth failed [{1}]',
        'qqGuildv2WebhookServerAPI_0003': 'OlivOS qqGuildv2 webhook server [{0}] payload error [{1}: {2}]',
        'qqGuildv2WebhookServerAPI_0004': 'OlivOS qqGuildv2 webhook server [{0}] callback verified',
    ...
    'zh-CN': {
        ...
        'pluginAPI_0016': 'OlivOS 插件组件 [{0}] 优先级调用顺序已应用: {1}',
        ...
        'milkyAutoServerAPI_0001': 'OlivOS Milky 自动连接服务组件 [{0}] WebSocket 连接 已经启动',
        'milkyAutoServerAPI_0002': 'OlivOS Milky 自动连接服务组件 [{0}] WebSocket 连接 已经关闭',
        'milkyAutoServerAPI_0003': 'OlivOS Milky 自动连接服务组件 [{0}] WebSocket 连接 已经丢失',
        'milkyAutoServerAPI_0004': 'OlivOS Milky 自动连接服务组件 [{0}] WebSocket 连接 将在{1}秒内重试',
        'milkyAutoServerAPI_0005': 'OlivOS Milky 自动连接服务组件 [{0}] WebSocket 连接 发生错误: \n{1}',
        ...
        'qqGuildv2WebhookServerAPI_0001': 'OlivOS QQ官方开放平台 Webhook 服务组件 [{0}] 正在运作于 [{1}]',
        'qqGuildv2WebhookServerAPI_0002': 'OlivOS QQ官方开放平台 Webhook 服务组件 [{0}] 鉴权失败 [{1}]',
        'qqGuildv2WebhookServerAPI_0003': 'OlivOS QQ官方开放平台 Webhook 服务组件 [{0}] 回调数据异常 [{1}: {2}]',
        'qqGuildv2WebhookServerAPI_0004': 'OlivOS QQ官方开放平台 Webhook 服务组件 [{0}] 回调地址验证完成',
